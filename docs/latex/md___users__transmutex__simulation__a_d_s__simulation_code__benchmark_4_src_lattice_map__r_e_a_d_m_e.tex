...
Author \+: Thomas Guilbaud ~\newline
 Date \+: 4th May 2021 ~\newline
 Updated\+: 9th June 2021\hypertarget{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md25}{}\doxysection{Structure}\label{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md25}
\hypertarget{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md26}{}\doxysubsection{General Use}\label{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md26}
...
To help writing an hexagonal shape lattice, one can place spaces before the rows (see the example below).\hypertarget{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md27}{}\doxysubsection{Special Use}\label{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md27}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md29}{}\doxysection{Simple example\+: Square Lattice}\label{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md29}
...
\end{DoxyCode}
\hypertarget{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md30}{}\doxysection{Hexagonal Lattice with numbers}\label{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md30}
...
\end{DoxyCode}
\hypertarget{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md31}{}\doxysection{How to use TMXLattice}\label{md___users__transmutex__simulation__a_d_s__simulation_code__benchmark_4_src_lattice_map__r_e_a_d_m_e_autotoc_md31}
